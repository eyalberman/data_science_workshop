...
cat(paste("The size of the initial data is",nrow(african_joined_table),"with",ncol(african_joined_table),                                        "features"))
```
...
cat(paste("The final size of the data is",nrow(african_joined_table),"with",ncol(african_joined_table),                                        "features"))
```
